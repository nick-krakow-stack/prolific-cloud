...
2026-05-18 23:38:47 +02:00 - Browser-Feedback:  # In app browser: - The user has the in-app browser open. - Current URL: https://prolific.nickkrakow.de/ ## My request for Codex: 1. Zusatzeinkommen bitte nach ganz rechts. Nach Einstellungen ein | und dann Zusatzeinkommen. 2. Die Telegram Befehle... ich hab vorhin versucht, zu pausieren, das hat aber nicht geklappt. Ich vermute, dass das daran liegt, dass das Plugin direkt pusht und nicht die Prolific Cloud. Ist die Frage: Kann nur das Plugin zur Cloud pushen oder k├Ânnen auch andersrum Dinge ├╝bertragen werden? Denn wenn das geht, dann w├ñre es sch├Ân, wenn die Pause via Telegram ans Backend geht, aber dann auch im Plugin eine Telegram Pause einstellt. Ich wei├ƒ, daf├╝r m├╝sste ich das Plugin umprogrammieren. Und zweitens w├ñre es nat├╝rlich super, wenn ich hier im Backend auf Aktualisieren tippe, wenn das auch den Sync im Plugin ausl├Âsen w├╝rde. Ist das m├Âglich? 
2026-05-18 23:51:57 +02:00 - Browser-Feedback:  # In app browser: - The user has the in-app browser open. - Current URL: https://prolific.nickkrakow.de/ ## My request for Codex: Okay, danke, gut zu wissen. Wir lassen das aber erstmal und bauen das Plugin nicht um. Aber was anderes: 1. Unter "Statistiken" ist die "Requester-Analyse". Die ganz linke ├£berschrift und die Namen k├Ânnen so bleiben. Alle anderen Spalten k├Ânnen aber bitt zentriert werden, also ├£berschrift und alles andere als Center. Ist dann leichter zu lesen. 2. Unter ├£bersicht finden sich die Tages- und Monatsziele. Hier wird leider wieder doppelt umgerechnet und deshalb stehen dort nicht die Zahlen aus den Einstellungen. 30Ôé¼ und 600Ôé¼ sollten es sein, es stehen dort aber Ôé¼ 30,01 und Ôé¼ 600,20. 3. Unter "Zusatzeinkommen" ist "Session nachtragen" schlecht formatiert. Mach das mal bitte in schick und auch moderner und ohne Anzeigefehler. 
