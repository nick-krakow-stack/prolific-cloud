...
<main class="container">
  ...
  <!-- ZUSATZEINKOMMEN -->
  <section class="tab-panel" id="panel-misc-income">
    <div id="miscIncomeContent" class="loading">Lade...</div>
  </section>

  <!-- ARBEIT-ZUHAUSE -->
  <section class="tab-panel" id="panel-work-home">
    <div id="workHomeContent" class="loading">Lade...</div>
  </section>
