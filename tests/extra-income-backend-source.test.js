...
assert(helper.includes('night_bonus_message_count INT NOT NULL DEFAULT 0'));
...
assert(helper.includes('night_bonus_message_count'));
assert(helper.includes('nightBonusMessageCount'));
...
assert(helper.includes('night_bonus_message_count\'] = extra_income_calculate_night_messages($part);'));
...
assert(install.includes('`night_bonus_message_count` INT NOT NULL DEFAULT 0'));
