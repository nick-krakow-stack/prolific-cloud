...
const checks = [
  ...
  ['uses readable system health count labels', systemHtml.includes('<span>Studien</span>') && systemHtml.includes('<span>Teilnahmen</span>') && systemHtml.includes('<span>Events</span>') && systemHtml.includes('<span>Sync-Log</span>') && !systemHtml.includes('<span>studies</span>') && !systemHtml.includes('<span>submissions</span>') && !systemHtml.includes('<span>syncLog</span>')],
