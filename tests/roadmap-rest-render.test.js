...
const checks = [
  ...
  ['uses readable system health count labels', systemHtml.includes('<span>Submissions</span>') && systemHtml.includes('<span>Sync-Log</span>') && !systemHtml.includes('<span>submissions</span>') && !systemHtml.includes('<span>syncLog</span>')],
