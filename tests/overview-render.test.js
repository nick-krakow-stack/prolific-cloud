...
const checks = [
  ...
  ['renders effective hourly KPI cards from EUR earnings including pending and paid worktime', html.includes('class="effective-hourly-grid"') && html.includes('<div class="label">EFFEKTIVER STUNDENLOHN MONAT</div>') && html.includes(`<div class="value">\u20ac57,53/h</div>`) && html.includes(`\u20ac115,05 in 2 h`) && html.includes('<div class="label">EFFEKTIVER STUNDENLOHN GESAMT</div>') && html.includes(`<div class="value">\u20ac23,36/h</div>`) && html.includes(`\u20ac194,70 in 8 h 20 min`)],
